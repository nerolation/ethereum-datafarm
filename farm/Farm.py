...
class Farm:
    def __init__(self, contracts, keyPath=".apikey/key.txt"):
        # Load API KEY
        ...
        print("\nInitiating Farm Instance with {} Contracts/Methods...".format(len(contracts)))
    ...
    def start_farming(self):
        ...
        self.log_header()
        while(endless):
            self.contracts = load_contracts(self.contracts, start=False, location=self.contracts[0].path)
