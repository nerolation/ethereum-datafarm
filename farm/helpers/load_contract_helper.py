    ...
    for contract in contractArray:
        ...
        # new contract => Contract object initiated and provided to the farm
            ...
            if awsfile:
                ...
                input("...overwritting `startBlock` to {} - please confirm".format(contracts[-1].fromBlock))
            ...
            # else, take `startBlock`from contracts file
                ...
                input("fromBlock not overwritten for {}. Please confirm".format(contracts[-1].name))
                pass
    return contracts
